		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-6 text-md-right">
					<a href="view_cart" class="btn btn-primary btn-lg pl-5 pr-5">Edit
						cart</a>
				</div>
			</div>
			<c:if test="${cart.totalItems > 0}">
				...
				<form action="place_order" method="post">
					<div class="row">
						<div class="col-12 text-center">
							...
							<div class="text-left">
								<table align="center">
									<tr>
										<td>First Name:</td>
										<td><input type="text" name="recipientFirstName"
											value="${loggedCustomer.firstName}" required="required"
											maxlength="32" /></td>
									</tr>
									<tr>
										<td>Last Name:</td>
										<td><input type="text" name="recipientLastName"
											value="${loggedCustomer.lastName}" required="required"
											maxlength="32" /></td>
									</tr>
									<tr>
										<td>Phone:</td>
										<td><input type="number" name="recipientPhone"
											value="${loggedCustomer.phone}" required="required"
											maxlength="16" /></td>
									</tr>
									<tr>
										<td>Address Line 1:</td>
										<td><input type="text" name="recipientAddressLine1"
											value="${loggedCustomer.addressLine1}" required="required"
											maxlength="128" /></td>
									</tr>
									<tr>
										<td>Address Line 2:</td>
										<td><input type="text" name="recipientAddressLine2"
											value="${loggedCustomer.addressLine2}" required="required"
											maxlength="128" /></td>
									</tr>
									<tr>
										<td>City:</td>
										<td><input type="text" name="recipientCity"
											value="${loggedCustomer.city}" required="required"
											maxlength="32"></td>
									</tr>
									<tr>
										<td>State:</td>
										<td><input type="text" name="recipientState"
											value="${loggedCustomer.state}" required="required"
											maxlength="32"></td>
									</tr>
									<tr>
										<td>Zip Code:</td>
										<td><input type="text" name="recipientZipCode"
											value="${loggedCustomer.zipCode}" required="required"
											maxlength="16" /></td>
									</tr>
									<tr>
										<td>Country:</td>
										<td><select name="recipientCountry"
						...
						<div class="products text-center container">
							<button class="btn btn-lg btn-outline-primary" type="submit">Place
								Order</button>
